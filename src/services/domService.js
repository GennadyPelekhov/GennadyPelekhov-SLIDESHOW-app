...
export const LOGGED_USER_SIGNUP = document.getElementById("logged-user-signup");
export const LOGGED_USER_LOGIN = document.getElementById("logged-user-login");
export const LOGGED_USER_LOGOUT = document.getElementById("logged-user-logout");
...
/* signup */
export const SIGNUP_FIRSTNAME_FIELD = document.getElementById(
  "signup-first-name-field"
);
export const SIGNUP_FIRSTNAME_ERROR = document.getElementById(
  "signup-first-name-error"
);
export const SIGNUP_LASTNAME_FIELD = document.getElementById(
  "signup-last-name-field"
);
export const SIGNUP_LASTNAME_ERROR = document.getElementById(
  "signup-last-name-error"
);
export const SIGNUP_COUNTRY_FIELD = document.getElementById(
  "signup-country-field"
);
export const SIGNUP_COUNTRY_ERROR = document.getElementById(
  "signup-country-error"
);
export const SIGNUP_STATE_FIELD = document.getElementById("signup-state-field");
export const SIGNUP_STATE_ERROR = document.getElementById("signup-state-error");
export const SIGNUP_CITY_FIELD = document.getElementById("signup-city-field");
export const SIGNUP_CITY_ERROR = document.getElementById("signup-city-error");
export const SIGNUP_STREET_FIELD = document.getElementById(
  "signup-street-field"
);
export const SIGNUP_STREET_ERROR = document.getElementById(
  "signup-street-error"
);
export const SIGNUP_HOUSE_FIELD = document.getElementById("signup-house-field");
export const SIGNUP_HOUSE_ERROR = document.getElementById("signup-house-error");
export const SIGNUP_ZIP_FIELD = document.getElementById("signup-zip-field");
export const SIGNUP_ZIP_ERROR = document.getElementById("signup-zip-error");
export const SIGNUP_EMAIL_FIELD = document.getElementById("signup-email-field");
export const SIGNUP_EMAIL_ERROR = document.getElementById("signup-email-error");
export const SIGNUP_PHONE_FIELD = document.getElementById("signup-phone-field");
export const SIGNUP_PHONE_ERROR = document.getElementById("signup-phone-error");
export const SIGNUP_PASSWORD_FIELD = document.getElementById(
  "signup-password-field"
);
export const SIGNUP_PASSWORD_ERROR = document.getElementById(
  "signup-password-error"
);
export const SIGNUP_PASSWORD_REENTER_FIELD = document.getElementById(
  "signup-password-reenter-field"
);
export const SIGNUP_PASSWORD_REENTER_ERROR = document.getElementById(
  "signup-password-reenter-error"
);
export const SIGNUP_ISBUSINESS_FIELD = document.getElementById(
  "signup-isBusiness-field"
);

export const SIGNUP_CANCEL_BTN = document.getElementById("signup-cancel-btn");
export const SIGNUP_SUBMIT_BTN = document.getElementById("signup-submit-btn");
