...
export const CREATE_PIC_PAGE = document.getElementById("create-picture-page");
export const LOGIN_PAGE = document.getElementById("login-page");
export const ERROR_PAGE = document.getElementById("error-page");
...
export const CREATE_PIC_PAGE_LINK = document.getElementById("create-page-link");
